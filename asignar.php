...
<B><P class="fuente_titulo_principal"><span class="fuente_normal"><CENTER><img src="sicor/images/archivos.gif" border="0" />PERSONALIZAR DERIVACI&Oacute;N - CORRESPONDENCIA INTERNA</CENTER><BR></B>
<?php
$gestion = strftime("%Y");
$error = 0;
